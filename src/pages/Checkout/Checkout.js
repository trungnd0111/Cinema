        ...
        return danhSachGhe.map((ghe, index) => {
            ...
            return <Fragment key={index}>
                <button onClick={() => {
                    ...
                    {ghe.daDat  ? classGheDaDuocDat != '' ? <UserOutlined style={{ verticalAlign: 'middle', fontWeight: 'bold' }} /> : <CloseOutlined style={{ fontWeight: 'bold', verticalAlign: 'middle' }} /> : classGheKhachDat !=='' ? <UserOutlined  style={{verticalAlign: 'middle', fontWeight: 'bold' }} />  :  ghe.stt}
                        ...
                        <table className=" divide-y divide-gray-200 w-2/3">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td><button className="ghe gheKhachDat text-center"> <CheckOutlined style={{ verticalAlign: 'middle', fontWeight: 'bold' }} /> </button> </td>
